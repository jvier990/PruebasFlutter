...
class _practicaState extends State<practica> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: Drawer(
            //A SHADOW COLOR NO LE VI DIFERENCIA A LO MEJOR PORQUE DEJE DE NEGRO TODO EL MENU
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  //AQUI PONDRIAMOS TODOS LOS COMPONENTES PARA EL MENU, IGUAL LOS COMPONENTES PODEMOS MIGRARLOS A UNA CARPETA DE COMPONENTS Y LLAMARLOS PARA HACER MAS LIMPIO EL CODIGO
                  /*IMAGEN */
                  Container(
                    width: 150,
                    height: 150,
                  ...
                  /*Compnente no tienen funcionalidad es meramente estatico por el momento vere si con unos botones puedo mandar a llamar a otra vista y que se vea igual, a lo mejor con el child del Container
                Ya los demas containers son iguales*/
                  Container(
                  ...
                  Container(
                    ...
                    width: double.infinity,
                    color: Colors.orange[400],
                    child: const Text("Que debo de comprar",
                        style: TextStyle(color: Colors.white70)),
                  ),
                  Container(
